  ...
  return (
    <div className="popupContainer">
      ...
      <p>
        ...
        <p>
          <img src={Walk} alt="Shoes" height="20" width="20" />
          {walkingTime} min
        </p>
      </p>
      <div>
        {logos.map((l) => {
          return l.sanitized === true ? (
            <img src={HappeePlace} alt={"sanitized"} />
          ) : (
            ""
          );
        })}
        {logos.map((l) => {
          return l.diaperchanger === true ? (
            <img src={BabyChanger} alt={"diaper-changer"} />
          ) : (
            ""
          );
        })}
      ...
      <button className="takeMeButton">Take me there</button>
    </div>
  );
}
